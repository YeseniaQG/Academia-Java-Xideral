...
public class SalesAnalyzer {
    public static void main(String[] args) {
        ...
        // 1. Ingreso total: mapToDouble convierte el stream de objetos a un stream de primitivos
        ...
        // 2. Ingresos por categoria: groupingBy(clasificador, sumador)
        ...
        // 3. Top 3 productos por monto: sorted(comparador) + limit(n)
        System.out.println("\n=== Top 3 Productos ===");
        sales.stream()
        ...
        // 6. Producto mas caro por region: maxBy retorna un Optional
        ...
        // 7. Conteo por mes: usando counting() como downstream collector
